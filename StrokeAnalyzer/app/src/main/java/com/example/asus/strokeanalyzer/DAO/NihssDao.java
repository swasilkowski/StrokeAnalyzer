...
public interface NihssDao {
     ...
     *
     * @param nihssExamination obiekt zawierający dane pojedynczego badania NIHSS, które ma zostać dodane do bazy danych
     * @return id badania dodanego do bazy danych
     */
    @Insert
     ...
     * @return lista badań dla skali NIHSS pacjenta
     */
     ...
     * @return najnowsze badanie pacjenta dla skali NIHSS
     */
     ...
     *
     * @param patientId id pacjenta, dla którego pobrane ma zostać badanie dla skali NIHSS
     * @return najstarsze badanie pacjenta dla skali NIHSS
     */
