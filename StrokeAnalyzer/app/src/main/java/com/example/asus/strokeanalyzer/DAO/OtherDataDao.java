...
public interface OtherDataDao {
     ...
     * @return lista odpowiedzi na pytania danego pacjenta
     */
     ...
     * @param answerId id pytania, dla którego szukamy odpowiedzi udzielonych przez pacjenta
     * @return liczba odpowiedzi znajdujących się w bazie danych na dane pytanie wybranego pacjenta
     */
