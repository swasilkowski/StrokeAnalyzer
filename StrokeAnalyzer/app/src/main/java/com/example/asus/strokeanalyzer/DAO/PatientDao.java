...
public interface PatientDao {
     ...
     *
     * @param patient obiekt klasy Patient, który ma zostać dodany do bazy danych
     * @return id pacjenta w bazie danych
     */
    @Insert
    long insert(Patient patient);

    /**
     * Metoda aktualizująca w bazie danych dane odnoszące się do pacjenta patient.
     *
     ...
     * @return obiekt zawierający dane pacjenta pozyskane z bazy danych
     */
     ...
     * @return liczba pacjentów o podanym numerze zapisanych w bazie danych
     */
